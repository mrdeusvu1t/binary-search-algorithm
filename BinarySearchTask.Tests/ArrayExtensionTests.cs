...
namespace BinarySearchTask.Tests
{
    public class ArrayExtensionTests
    {
        ...
        public int BinarySearchTests_Return_Index_Of_Value_In_Array(int[] source, int value)
        {
        ...
        [TestCase(new[] {1, 3, 5, 8, 13, 21, 34, 55, 89, 144, 233, 377}, 21, ExpectedResult = 5)]
        public int? BinarySearchTests_Return_Null(int[] source, int value)
        {
            return BinarySearch(source, value);
        }

        [Test]
        public static void BinarySearchTests_Throw_ArgumentNullException_If_Source_Array_Is_Null()
